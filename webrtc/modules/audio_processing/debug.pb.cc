...
RuntimeSetting::RuntimeSetting(const RuntimeSetting& from)
  ...
  ::memcpy(&capture_pre_gain_, &from.capture_pre_gain_,
    static_cast<size_t>(reinterpret_cast<char*>(&custom_render_processing_setting_) -
    reinterpret_cast<char*>(&capture_pre_gain_)) + sizeof(custom_render_processing_setting_));
...
void RuntimeSetting::SharedCtor() {
  ::memset(&capture_pre_gain_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&custom_render_processing_setting_) -
      reinterpret_cast<char*>(&capture_pre_gain_)) + sizeof(custom_render_processing_setting_));
}
